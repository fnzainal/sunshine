 ...
 */
package id.zainalfahrudin.sunshine.data;
...
import id.zainalfahrudin.sunshine.data.WeatherContract.LocationEntry;
import id.zainalfahrudin.sunshine.data.WeatherContract.WeatherEntry;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        // content://id.zainalfahrudin.sunshine/weather/
        String type = mContext.getContentResolver().getType(WeatherEntry.CONTENT_URI);
        // vnd.android.cursor.dir/id.zainalfahrudin.sunshine/weather
        assertEquals("Error: the WeatherEntry CONTENT_URI should return WeatherEntry.CONTENT_TYPE",
                WeatherEntry.CONTENT_TYPE, type);

        String testLocation = "94074";
        // content://id.zainalfahrudin.sunshine/weather/94074
        ...
        // content://id.zainalfahrudin.sunshine/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/id.zainalfahrudin.sunshine/weather/1419120000
        assertEquals("Error: the WeatherEntry CONTENT_URI with location and date should return WeatherEntry.CONTENT_ITEM_TYPE",
                WeatherEntry.CONTENT_ITEM_TYPE, type);

        // content://id.zainalfahrudin.sunshine/location/
        type = mContext.getContentResolver().getType(LocationEntry.CONTENT_URI);
        // vnd.android.cursor.dir/id.zainalfahrudin.sunshine/location
